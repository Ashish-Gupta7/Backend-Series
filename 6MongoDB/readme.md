...
4. ODM, document-oriented databases jaise ki MongoDB ke liye design kiya gaya hai.
5. Isme objects ko document format (jaise ki JSON) ke documents se map kiya jata hai.
6. ODM ka use MongoDB, Couchbase, aur other document-oriented databases ke liye kiya jata hai.
...
4. Model creation in code Collection creation in MongoDB
5. Schema creation in model Document structure creation in collection
6. schema field Document field
